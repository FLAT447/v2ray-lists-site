...
<div class="contacts">
                ...
                {#if screen === "main"}
                    ...
                    >
                        <div class="contacts__item-content">
                            <div
                                class="contacts__icon-circle contacts__icon-circle--telegram"
                            >
                    ...
                    <button onclick={goToPM} class="contacts__item">
                        ...
                        <FontAwesomeIcon
                            icon={faChevronRight}
                            class="contacts__chevron"
                        />
                    </button>
                {:else}
                    <button
                        onclick={goToMain}
                        class="contacts__item contacts__item--back"
                    >
                        <div class="contacts__item-content">
                    ...
                    >
                        <div class="contacts__item-content">
                            <div
                                class="contacts__icon-circle contacts__icon-circle--vk"
                            >
    ...
    <button onclick={toggleMenu} class="contacts__toggle">
        ...
        <div class="contacts__toggle-wrapper">
            {#if view === "open"}
                <div in:fade class="contacts__toggle-icon">
...
<style>
    * {
    ...
    .contacts__icon-circle--telegram {
